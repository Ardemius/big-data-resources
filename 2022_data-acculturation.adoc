...
[NOTE]
====
Schéma simple et clair d'une *architecture data lake dans le Cloud*, Azure ici : +
image:cloud-data-lake-architecture-azure.png[]

Cette image provient d'un très bon article de 2020 de Lynn Langit sur la construction de data pipelines pour les charges de travail à échelle génomique (donc très grande échelle) : +
https://lynnlangit.medium.com/azure-for-genomic-scale-workloads-ad3c989a3d0b
====
...
image::data-lakehouse-architecture.png[]
